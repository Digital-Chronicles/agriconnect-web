    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="bg-white shadow-xl rounded-3xl border border-slate-200 p-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Join AgriConnect and continue with your Google account.
            </p>
          </div>
          ...
          <div className="mt-8 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4">
            ...
            <ul className="mt-2 space-y-1 text-sm text-emerald-800 list-disc pl-5">
              <li>Google provider must be enabled in Supabase</li>
              <li>
                Redirect URL must include <span className="font-medium">/auth/callback</span>
              </li>
              <li>
                Site URL should be your Vercel production domain for live use
              </li>
            </ul>
          </div>
        ...
        <p className="mt-6 text-center text-xs text-slate-500">
          By continuing, you agree to AgriConnect&apos;s Terms and Privacy Policy.
        </p>
      </div>
    </div>
  );
